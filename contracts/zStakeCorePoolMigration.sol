 ...
 * @dev Upgrade: This contract is a modified version of zStakeCorePool.sol
 *      with added withdrawal functionality for migration purposes
 *
 * @author Pedro Bergamini, reviewed by Basil Gorin, modified by Zer0
 */
contract zStakeCorePoolMigration is zStakePoolBase {
